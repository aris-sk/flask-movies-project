...
class Movie(db.Model):
    ...
    ## Integer, δήλωση πεδίου βαθμολογίας ταινίας, με προεπιλεγμένη τιμή: default=1, υποχρεωτικό πεδίο
    ...
    release_year = db.Column(db.Integer, nullable=True, default=2000)
